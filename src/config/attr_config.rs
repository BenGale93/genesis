...
struct AttributeConfigValidator {
    ...
    eye_range: MinMax,
    eye_angle: MinMax,
    internal_timer_boundary: MinMax,
    lay_egg_boundary: MinMax,
    want_to_grow_boundary: MinMax,
    eating_boundary: MinMax,
...
impl Default for AttributeConfigValidator {
    fn default() -> Self {
        Self {
            ...
            internal_timer_boundary: (Some(-1.0), Some(1.0)),
            lay_egg_boundary: (Some(-1.0), Some(1.0)),
            want_to_grow_boundary: (Some(-1.0), Some(1.0)),
            eating_boundary: (Some(-1.0), Some(1.0)),
